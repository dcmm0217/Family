...
​	![image-20220224175156082](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224175156082.png)
...
![image-20220224175324186](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224175324186.png)
...
![image-20220224214414090](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224214414090.png)
...
![image-20220224220844971](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224220844971.png)
...
![image-20220224221159221](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224221159221.png)

但是需要主从切换，需要人工参与，会提高人力劳动成本。不过Redis已经有成熟的解决方案了，也就是**Redis哨兵模式（Sentinel）**，可以灵活自动切换，不再需要人工介入。

![image-20220224221329509](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224221329509.png)
...
![image-20220224222157128](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224222157128.png)
...
![image-20220224222954970](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224222954970.png)

其他锁获取，这种情况几乎无解。这时候GC回来了，那么两个进程就获取到了同一个分布式锁。

![image-20220224223052998](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224223052998.png)
...
![image-20220224225611684](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220224225611684.png)
