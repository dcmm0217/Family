...
`log_bin_use_v1_row_events`：此只读系统变量以弃用。ON表示使用版本1二进制日志行，OFF表示使用版本2二进制日志行（Mysql5.6的默认值为2）
...
![image-20220303124503038](https://mygiteepic.oss-cn-shenzhen.aliyuncs.com/img/image-20220303124503038.png)
