...
public class Instance {
     ...
     * 格式例如，192.168.3.8#8082#myItdachangCluster#my_atguigu@@abcmsc-provider-depart
     * IP # 端口 # 集群名称 # groupId # 微服务名称
     */
    ...
    /**
     * If instance is enabled to accept request. 实例是否可用
     */
    private boolean enabled = true;

    /**
     * If instance is ephemeral.
     * 实例是否是 临时实例（默认true） 目的为了弹性扩容，适合互联网项目
     * false为 持久实例 直接持久花到磁盘
     *
     * @since 1.0.0
     */
    ...
    /**
     * cluster information of instance. 集群名称
     * 一个实例只会隶属于一个cluster
     */
